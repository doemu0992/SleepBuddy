...
> **„Smart Alarm"-Anzeige (SleepDetailView summaryCard / StatistikView):** zeigt `alarmFiredDate` = **tatsächliche Weckzeit** (wann der Smart Alarm klang). Nur sichtbar wenn der Alarm wirklich ausgelöst hat (manueller Stopp → nil → keine Anzeige).
>
